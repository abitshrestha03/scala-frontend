...
const FeaturedArticles = () => {
  const articles = [
    ...
    },
    {
      title: "The Reasons Why Your Products Suck in The Marketplace",
      author: "Scala Technologies",
      image: "https://via.placeholder.com/350x200?text=Article+1",
    },
    {
      title: "The Reasons Why Your Products Suck in The Marketplace",
      author: "Scala Technologies",
      image: "https://via.placeholder.com/350x200?text=Article+2",
    },
    {
      title: "The Reasons Why Your Products Suck in The Marketplace",
      author: "Scala Technologies",
      image: "https://via.placeholder.com/350x200?text=Article+3",
    },
  ];
  ...
  return (
    <div className="text-white py-10 px-6">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-white text-center font-semibold ms:text-3xl sm:text-5xl md:tracking-[0.04em] mb-2">Featured Articles</h2>
